import{j as e}from"./markdown-Cxpyo6vT.js";import{b as a}from"./vendor-Cbm2kc8j.js";import{u as b}from"./index-BFpm75Ip.js";import{S as P}from"./SEOHead-DYQLs8MZ.js";import"./supabase-BiHzSKx7.js";import"./pdf-ckwbz45p.js";const m=[{key:"all",ko:"전체",en:"All"},{key:"code",ko:"코드",en:"Code"},{key:"writing",ko:"글쓰기",en:"Writing"},{key:"analysis",ko:"분석",en:"Analysis"},{key:"creative",ko:"창작",en:"Creative"},{key:"business",ko:"비즈니스",en:"Business"}],r=[{category:"code",title:{ko:"Python 코드 리뷰어",en:"Python Code Reviewer"},desc:{ko:"Python 코드의 버그, 성능, 스타일을 분석하는 전문 리뷰어",en:"Expert reviewer for Python code bugs, performance, and style"},prompt:{ko:`당신은 시니어 Python 개발자입니다. 제가 보내는 코드를 다음 기준으로 리뷰해 주세요:
