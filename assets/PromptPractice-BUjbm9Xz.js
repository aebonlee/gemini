import{j as e}from"./markdown-Cxpyo6vT.js";import{b as r}from"./vendor-Cbm2kc8j.js";import{u}from"./index-BFpm75Ip.js";import{S as h}from"./SEOHead-DYQLs8MZ.js";import"./supabase-BiHzSKx7.js";import"./pdf-ckwbz45p.js";const g=[{label:{ko:"코드 리뷰",en:"Code Review"},prompt:{ko:"다음 코드를 리뷰해 주세요. 버그, 성능 개선점, 코드 스타일 개선을 제안해 주세요.\n\n```\n// 여기에 코드를 붙여넣으세요\n```",en:"Please review the following code. Suggest bug fixes, performance improvements, and code style improvements.\n\n```\n// Paste your code here\n```"}},{label:{ko:"문서 요약",en:"Document Summary"},prompt:{ko:`다음 문서를 3가지 핵심 포인트로 요약해 주세요. 각 포인트는 2~3문장으로 작성하세요.
